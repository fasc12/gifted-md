...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~FfkDGbgb#iKwOpRv_iCLMRynyQMiczBR_WIz-1kNRp3MjYIclPj4", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "263778858246", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "263778858246", // Only 1 owner Number Here, others Add to sudo numbers...
